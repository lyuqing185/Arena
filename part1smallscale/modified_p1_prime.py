...
Q_LABELS = [
    ...
    "Q2. Placement — Which version presents the advertisement earlier in the response?",
    "Q3. Ad noticeability — In which version does the advertisement stand out more?",
    ...
    "Q6. Helpfulness — Which version better answers the user's question?",
]
